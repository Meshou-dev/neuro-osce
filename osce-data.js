  ...
  stations: [
    {
      ...
      card:'<p style="font-size:16px;line-height:1.75;margin:0 0 14px">You are the on-call neurology registrar in the Emergency Department at 03:10. A 68-year-old man is brought by his family with sudden right-sided weakness and slurred speech. Symptoms began about 90 minutes ago; he was last seen well 90 minutes ago. Background: hypertension, type 2 diabetes and atrial fibrillation; not anticoagulated. Independent at baseline. No recent surgery, trauma, bleeding or anticoagulant use.</p>'
      ...
      items:[
        {domain:"Data-Gathering", q:"What further points would you confirm on history before reperfusion?", model:"Confirm exact time last-known-well (90 min). Screen thrombolysis contraindications: recent surgery/trauma, MI, bleeding/anticoagulation, prior stroke or ICH. Exclude hypoglycaemia.", max:2},
        ...
        {domain:"Decision-Making", q:"Is he a thrombolysis candidate? Agent and dose?", model:"Yes: within 4.5 h, no haemorrhage and no contraindication. Alteplase 0.9 mg/kg (max 90 mg) or tenecteplase 0.25 mg/kg (max 25 mg).", max:2},
        ...
        {domain:"Decision-Making", q:"BP is 182/98: manage it around thrombolysis.", model:"<185/110 before lysis (acceptable now; if it rises, use labetalol/nicardipine); keep <180/105 for 24 h after. If not reperfusing, allow permissive hypertension; treat only >220/120.", max:2},
        ...
        {domain:"Decision-Making", q:"During the infusion: severe headache and a drop in GCS; then lip swelling.", model:"Stop the infusion. Obtain an urgent non-contrast CT and CBC/coagulation/fibrinogen. Reverse with cryoprecipitate ± platelets/TXA; involve neurosurgery. Oro-lingual angio-oedema: secure airway, IV methylprednisolone + antihistamine ± adrenaline.", max:2},
        {domain:"Decision-Making", q:"Post-thrombolysis care and secondary prevention.", model:"Stroke unit with monitoring for 24 h. NPO, then swallow screen; IV saline (no dextrose). Give aspirin after 24 h, after repeat CT. IPC from admission; pharmacological VTE prophylaxis after 24 h. Anticoagulate for AF according to infarct size. Statin.", max:2}
      ]
    },
...

    {
      ...
      items:[
        ...
        {domain:"Decision-Making", q:"First-line drug, route and dose?", model:"Use a benzodiazepine: lorazepam 0.1 mg/kg IV (max 4 mg/dose, may repeat once), IM midazolam 10 mg if no IV, or diazepam 0.15–0.2 mg/kg IV (max 10 mg). The pre-hospital 2 mg was under-dosed.", max:2},
