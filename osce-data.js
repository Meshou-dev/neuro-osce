  ...
  stations: [
...

    {
      ...
      card:'<p style="font-size:16px;line-height:1.75;margin:0 0 14px">You are the medical registrar in the Emergency Department resuscitation area. A 34-year-old woman with known myasthenia gravis (on pyridostigmine) presents with three days of worsening breathlessness, nasal-sounding speech and difficulty swallowing; she can no longer lie flat. She had a chest infection last week and was started on azithromycin. No chest pain.</p>'
        ...
        +'<div class="kicker" style="margin-top:12px">Vital signs</div><div class="vitals"><div class="vital warn2"><div class="lab">RR</div><div class="num">28</div></div><div class="vital flag"><div class="lab">SpO₂</div><div class="num">92%</div></div><div class="vital warn2"><div class="lab">HR</div><div class="num">112</div></div><div class="vital"><div class="lab">BP</div><div class="num">138/84</div></div><div class="vital"><div class="lab">Temp</div><div class="num">37.4</div></div><div class="vital warn2"><div class="lab">Breath count</div><div class="num">12</div></div></div>',
      ...
      items:[
        {domain:"Data-Gathering", q:"Diagnosis and what makes it a crisis?", model:"Myasthenic crisis — MG exacerbation causing respiratory failure or inability to protect the airway; bulbar + respiratory weakness are the danger signs.", max:2},
        {domain:"Data-Gathering", q:"How do you assess respiratory status at the bedside?", model:"Serial FVC and NIF/MIP, single-breath count, cough strength, neck-flexion strength, orthopnoea, sentence length.", max:2},
        {domain:"Reasoning", q:"Why not rely on the SpO₂ / ABG?", model:"In neuromuscular failure the saturation falls and the CO₂ rises only late — the FVC/NIF trend leads. This patient already shows failure: FVC 0.9 L, NIF −22, rising CO₂ 6.9 kPa, SpO₂ 92%.", max:2},
        {domain:"Decision-Making", q:"When would you secure the airway?", model:"20·30·40 guide (FVC <20 mL/kg ≈ <1 L, NIF weaker than −30, MEP <40) or a falling trend — not an automatic trigger; also intubate for bulbar failure. This patient needs intubation: bulbar failure, secretions, weak cough, rising CO₂.", max:2},
...

    {
      ...
      card:'<p style="font-size:16px;line-height:1.75;margin:0 0 14px">You are the medical registrar leading the resuscitation. A 24-year-old man with known epilepsy is brought in by ambulance and is convulsing — generalised tonic–clonic activity that, according to the paramedics, has been continuous for at least 8 minutes. He ran out of his medication a few days ago. The paramedics gave <b>IV lorazepam 2 mg</b> about 4 minutes ago with no effect. No trauma or fever reported.</p>'
        +'<div class="kicker">On arrival (still seizing)</div><div class="vitals"><div class="vital flag"><div class="lab">State</div><div class="num">Seizing</div></div><div class="vital warn2"><div class="lab">SpO₂</div><div class="num">89%</div></div><div class="vital warn2"><div class="lab">HR</div><div class="num">126</div></div><div class="vital"><div class="lab">BP</div><div class="num">148/90</div></div><div class="vital warn2"><div class="lab">Temp</div><div class="num">37.9</div></div><div class="vital"><div class="lab">Glucose</div><div class="num">?</div></div></div>',
